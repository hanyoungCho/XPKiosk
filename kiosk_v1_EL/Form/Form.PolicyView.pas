...
begin
  ...
  begin
    ...
    if global.Config.AdvertEvent = True then
      Inc(FMaxPage);
  end
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        //sLoadFile := TAdvertisement(Global.SaleModule.AdvertisementListPopup[0]).FilePath;
        //Image.Bitmap.LoadFromFile(sLoadFile)
        //Image.Bitmap.LoadFromFile('D:\Works\XGolf\bin_kiosk\Intro\popuptest.jpg')
      end;
