...
type
  ...
  TDeviceManager = class
  private
    var FMouseNotifier: TMouseNotifier;
    var FKeyboardNotifier: TKeyboardNotifier;
    var FBlocking: Boolean;
  ...
  public
    ...
    property Keyboard: TKeyboardNotifier read FKeyboardNotifier;
    property Mouse: TMouseNotifier read FMouseNotifier;
...
begin
  ...
  PSHook := TPSHook.Create;
  FMouseNotifier := TMouseNotifier.Create(PSHook.GetMouseHook());
  FKeyboardNotifier := TKeyboardNotifier.Create(PSHook.GetKeyboardHook());
...
procedure TKeyboardNotifier.on_KeyDown(Key: Word; Shift: TShiftState;
  var Handled: Boolean);
begin
  KeyEvent(TDeviceEvent.Down, Key, Shift, Handled);
end;

procedure TKeyboardNotifier.on_KeyUp(Key: Word; Shift: TShiftState;
  var Handled: Boolean);
begin
...
begin
  MouseEvent(TDeviceEvent.Move, TPSMouseButton.None, [], X, Y, Handled);
end;
