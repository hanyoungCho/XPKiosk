...
begin
  try
    try
      ...
      //2021-07-07 JMS 6*6
      //if (Global.Config.Store.StoreCode = 'A8001') or (Global.Config.Store.StoreCode = 'A3001') then //쇼골프,JMS
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            if Global.Config.Store.StoreCode = 'AD001' then //한강
            begin
              inc(nPageBoxCnt);
              if APage = 1 then
              begin
        ...
        begin
          ...
          ASelectBoxProductItemStyle.Position.X := 35 + (14 * ColIndex) + ColIndex * (ASelectBoxProductItemStyle.Width * 0.9); //35 말풍선영역
          ASelectBoxProductItemStyle.Position.Y := 15 + (14 * RowIndex) + RowIndex * (ASelectBoxProductItemStyle.Height * 0.9); //15 말풍선영역
        end
        else //5
        begin
        ...
        begin
          if Global.SaleModule.TeeBoxSortType = tstLowTime then //빠른타석
          begin
            if BoxCnt = 24 then
              break;
          end;
        ...
        begin
          ...
          begin
            ...
            begin
              ...
              if Result.Count = 50 then // 빠른타석 표시수변경
                Continue;
            end;
