...
type
  ...
  TPopUpLevel = (plNone, plAuthentication, plHalbu, plPhone, plMemberItemType, plXGolf, plPromotionCode, plTeeboxChange, plXGolfEvent);
  TPopUpFullLevel = (pflNone, pflCoupon, pflPayCard, pflPrint, pflTeeBoxPrint, pflQR, pflPeriod, pflPromo, pflProduct);
