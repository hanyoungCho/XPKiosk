...
begin
  try
    ...
    begin
      ...
      begin
        Global.XPErpApi.SendAdvertisCnt(IntToStr(Global.SaleModule.AdvertisementListDown[FIndex].Seq));
...
begin
  ...
  begin
    if Global.SaleModule.AdvertisementListDown.Count <> 0 then
    begin
      Global.XPErpApi.SendAdvertisCnt(IntToStr(Global.SaleModule.AdvertisementListDown[0].Seq));
