...
/////////////////////         MSG//////////////////////////////////
  ...
  MSG_VIP_ONLY_DAY_PRODUCT = 'TEAM타석은 일일고객만 사용이 가능합니다';
...
type
  ...
  TPopUpLevel = (plNone, plAuthentication, plHalbu, plPhone, plMemberItemType, plXGolf, plPromotionCode, plTeeboxChange);
  TPopUpFullLevel = (pflNone, pflCoupon, pflPayCard, pflPrint, pflTeeBoxPrint, pflQR, pflPeriod, pflSelectTime, pflPromo, pflProduct, pflBunkerMember, pflCheckInFinger, pflCheckInPrint);
  TMemberItemType = (mitNone, mitperiod, mitCoupon, mitDay, mitBunkerMember, mitBunkerNonMember);
  ...
  TCardApplyType = (catNone, catAppCard, catMagnetic);

  TPromotionType = (pttNone, pttSelect, pttWellbeing, pttTheloungemembers, pttBCPaybookGolf, pttRefreshclub, pttIkozen);
