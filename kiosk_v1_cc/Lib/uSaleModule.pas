...
begin
  try
    ...
    begin
      Global.SBMessage.ShowMessageModalForm('퍼팅/벙커 게임구매는 1개만 가능합니다.');
      Exit;
      Result := True;
    end;
  ...
  try
    ...
    //      Exit;
      ...
      begin
        ...
        begin
          if Global.SBMessage.ShowMessageModalForm(MSG_SALE_PRODUCT_RESERVE_SEARCH, False) then // 할래말래?
          begin
            if Global.SaleModule.ProductList.Count = 1 then
            begin
              ...
              begin
                //실패
                Log.E('Sale TeeBoxListReservation_1', '예약배정 실패');
                Global.SaleModule.PopUpFullLevel := pflPrint;
            ...
            begin
              ...
              begin
                ...
                begin
                  ...
                  Log.E('Sale TeeBoxListReservation_2', '예약배정 실패');
    ...
    try
      ...
      begin // 예약 배정 등록
        ...
        if not Global.Database.BunkerReservation then
          Log.E('BunkerReservation', '예약배정 실패');
