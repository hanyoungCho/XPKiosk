...
uses
  uStruct, System.Variants, System.DateUtils,
...
type
  ...
  public
    ...
    function GetMemberInfo(ACardNo: string; out AMsg: string): TMemberInfo; override;
    // 회원의 상품 리스트를 가져온다
...
function TGMDatabase.GetMemberInfo(ACardNo: string; out AMsg: string): TMemberInfo;
var
  Index: Integer;
  AQuery: TUniQuery;
begin
