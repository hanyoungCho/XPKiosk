...
//        Image.Bitmap.LoadFromFile(Global.SaleModule.AdvertisementListDown[FIndex].FilePath);
        Image.Bitmap := Global.SaleModule.AdvertisementListDown[FIndex].Image;
//        Result := StrToInt(Global.SaleModule.AdvertisementListDown[FIndex].Show_Interval);
        Inc(FIndex);
      end
      else
      begin
